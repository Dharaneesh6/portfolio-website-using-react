...
//     desc: 'Production-ready MERN e-commerce ecosystem with JWT authentication, role-based access control, product catalogue, cart & order REST APIs, Cloudinary media pipeline, and Stripe payments. Deployed on Vercel.',
...
//     desc: 'End-to-end coffee shop management with admin dashboard, JWT auth, product & event APIs, reservation system, and order tracking. MongoDB backend, Cloudinary for media, deployed on Vercel.',
...
//     active: false,
//     bullets: [
//       { tag: '20% faster',       text: 'Integrated 6+ frontend UI components with backend APIs, reducing average page load times by 20%.' },
//       { tag: '100% responsive',  text: 'Ensured full responsive compatibility across desktop, tablet, and mobile breakpoints.' },
//       { tag: '35% fewer errors', text: 'Optimised input validation logic, reducing form submission errors and improving data quality by 35%.' },
//     ],
//   },
// ];
...
//                   className="text-[11px] font-bold uppercase tracking-widest text-gray-400 hover:text-white transition-colors bg-transparent border-none cursor-pointer">
//                   {l}
//                 </button>
//               ))}
//             </div>
...
//               <a href="#"
//                 className="hidden sm:flex items-center gap-2 border border-white/10 hover:border-blue-500/50 px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all hover:bg-blue-500/5">
//                 Resume <Download size={13} className="text-blue-500" />
//               </a>
//               <button onClick={() => go('contact')}
//                 className="bg-blue-600 text-white px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-[0_0_20px_rgba(59,130,246,.35)] border-none cursor-pointer">
//                 Hire Me
//               </button>
...
//               <p className="text-blue-500 font-bold tracking-[0.3em] text-xs uppercase mb-5">Full Stack Developer</p>

//               <h1 className="syne text-6xl sm:text-7xl md:text-8xl lg:text-[6.5rem] font-bold leading-[1.02] mb-8">
//                 Engineering<br/>
//                 <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.3)' }}>Scalable</span>{' '}
//                 Solutions<br/>
//                 With Precision<span className="text-blue-500">.</span>
//               </h1>
...
//                 currently engineering fintech APIs and automation workflows at{' '}
...
//                 </button>
//                 <button onClick={() => go('contact')}
//                   className="border border-white/15 text-white px-7 py-3.5 rounded-full text-[11px] font-black uppercase tracking-widest hover:border-white/40 hover:bg-white/5 transition-all bg-transparent cursor-pointer">
//                   Get In Touch
//                 </button>
//               </div>
//             </motion.div>
...
//             >
//               {[['10+','RESTful APIs Built'],['5K+','Monthly API Requests'],['70%','Page Load Improved'],['60%','Reporting Automated']].map(([n,l]) => (
//                 <div key={l}>
...
//               {['REST APIs','MVC Architecture','Performance Optimisation','Agile / Scrum','Cross-functional Teams','Database Design'].map(t => (
...
//               { emoji:'💡', title:'Problem Solver', sub:'Detail-oriented · scalable architecture · clean code · measurable business impact' },
//             ].map(({ emoji, title, sub }) => (
...
//           {/* Vertical line — starts at first dot position */}
//           <div className="absolute left-[6px] top-5 bottom-0 w-px bg-white/8" />
...
//                 {/* Dot — centred exactly on the line */}
//                 <span className={`absolute -left-10 top-[6px] w-[13px] h-[13px] rounded-full border-2 border-[#050505] ring-2 block ${
//                   job.active ? 'bg-blue-500 ring-blue-500/30 shadow-[0_0_14px_rgba(59,130,246,0.5)]' : 'bg-gray-600 ring-white/10'
//                 }`} />

//                 <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-4">
//                   <div>
//                     <h3 className="syne text-xl font-bold text-white">{job.role}</h3>
//                     <p className="text-gray-500 font-bold text-sm uppercase tracking-widest mt-1">{job.company}</p>
//                   </div>
//                   <span className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-4 py-1.5 rounded-full whitespace-nowrap self-start ${
//                     job.active
//                       ? 'text-blue-400 bg-blue-500/10 border border-blue-500/20'
//                       : 'text-gray-500 bg-white/5 border border-white/10'
//                   }`}>
//                     {job.active && <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />}
//                     {job.period}
//                   </span>
//                 </div>
...
//                     <li key={tag} className="flex gap-3 text-sm text-gray-400 leading-relaxed">
//                       <span className="shrink-0 self-start mt-0.5 text-[10px] font-black text-gray-900 bg-blue-500 px-2.5 py-0.5 rounded-full whitespace-nowrap">
//                         {tag}
//                       </span>
//                       {text}
//                     </li>
...
//               className="bg-white/[0.03] border border-white/8 rounded-2xl p-5 flex flex-col items-center gap-3 transition-colors cursor-default">
...
//           {['Problem Solving','Collaboration','Communication','Detail-Oriented','Scalable Architecture','Agile / Scrum'].map(s => (
...
//           src={p.img}
//           alt={p.title}
//           className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-90 group-hover:scale-105 transition-all duration-700"
//         />
...
//                 Actively looking for entry-level full-stack developer roles. If you're building something exciting or want to collaborate — reach out.
//               </p>
//             </motion.div>
...
//                 { Icon: Linkedin, label:'LinkedIn', value:'linkedin.com/in/dharaneesh',href:'#' },
//                 { Icon: Github,   label:'GitHub',   value:'github.com/dharaneesh',     href:'#' },
...
//                 {[
//                   ['Full-Stack Developer','Entry-level · 1 yr experience'],
//                   ['Ruby on Rails / Node.js','Backend APIs & system design'],
//                   ['React.js','Responsive, accessible UIs'],
//                   ['Remote or On-Site','Tamil Nadu / India'],
//                 ].map(([title, sub]) => (
...
//                   <ul className="space-y-3 text-sm text-gray-400">
//                     {[['LinkedIn','#'],['GitHub','#'],['Email','mailto:dharaneesh2406@gmail.com']].map(([l, h]) => (
//                       <li key={l}>
...
//                     ))}
//                     <li>
//                       <a href="#" className="hover:text-white transition-colors flex items-center gap-2 no-underline text-gray-400">
